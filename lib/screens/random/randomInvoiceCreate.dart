...
import 'package:invoice_reckon/screens/random/randomEditItem.dart';
...
class RandomInvoiceCreate extends StatefulWidget {

  final String custName, invoiceId,custPhone,uid;


  RandomInvoiceCreate({this.custName, this.invoiceId,this.uid, this.custPhone});

  @override
  _RandomInvoiceCreateState createState() => _RandomInvoiceCreateState();
}

class _RandomInvoiceCreateState extends State<RandomInvoiceCreate> {
  ...
  Future<void> _showDeleteDialog(String  itemName){
    return showDialog(
        context: context,
        builder: (context){
          return AlertDialog(
    ...
    return StreamBuilder<QuerySnapshot> (
      ...
      builder: (context, snapshot) {
        if (!snapshot.hasData) {
          return Scaffold(
              appBar: AppBar(),
              body: Center(child: CircularProgressIndicator(backgroundColor: Colors.redAccent)));
        }
                      ...
                      return SimpleDialog(
                        ...
                        children: <Widget>[
                          ...
                          SimpleDialogOption(
                            ...
                            onPressed: () {
                              Navigator.pop(context);
                              _showDeleteDialog(item.itemName);
                            },
                          )
                        ],
                      );
            ...
            appBar: AppBar(
              title: Row(
                children: [
                  ...
                  Spacer(),
                  Text(
                    widget.custName,style: TextStyle(color: Colors.black),
                  ),
                ],
              ),
              actions: [
                IconButton(
                onPressed: (){
                  _sendMessage('${widget.custPhone}', 'Hi sir/mam:;\n'
                  'Your Name:         ${widget.custName}\n'
                  'Your PhoneNo:      ${widget.custPhone}\n'
                  'Your Total Amount: $itemTotal\n'
                  'Your InvoiceId:    ${widget.invoiceId}\n'
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    TextFormField(
                                      validator: (val) => val.isEmpty ? "Enter randomGst name" : null,
                                    ...
                                    TextFormField(
                                      ...
                                      validator: (val) => val.isEmpty ? "Enter randomGst price" : null,
                                      decoration: InputDecoration(
                                        hintText: "Item Price",
                                    ...
                                    SizedBox(height: 5.0,),
                                    TextFormField(
                                      validator: (val) => val.isEmpty ? "Enter randomGst quantity" : null,
                                      keyboardType: TextInputType.number,
                                      decoration: InputDecoration(
